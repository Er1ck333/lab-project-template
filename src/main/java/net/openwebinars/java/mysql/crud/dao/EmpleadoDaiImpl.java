...
public class EmpleadoDaiImpl implements EmpleadoDao {

    private static  EmpleadoDaiImpl instance;

    static {
        instance = new EmpleadoDaiImpl();
    }

    private EmpleadoDaiImpl() {}

    public static EmpleadoDaiImpl getInstance() {
        return instance;
    }
